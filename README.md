...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=18&pause=1000&color=A78BFA&center=true&vCenter=true&width=500&lines=Full-Stack+Developer+%F0%9F%9A%80;AI+Agents+Enthusiast;LeetCode+Grinder+%F0%9F%A7%A9;Building+tools+that+matter+%E2%9C%A8)](https://git.io/typing-svg)
...
- 🔄 Built automated workflows using n8n for seamless data collection & transformation
- 🔗 Integrated processed data into interactive Power BI dashboards
- ⏱️ Reduced manual reporting effort through scheduled automation pipelines
- 📊 Delivered real-time insights via fully connected data workflows
- 🧠 Designed scalable pipelines for continuous data refresh & monitoring

`n8n` `AI agents` `Power BI` `APIs` `Automation`
